Contributing to GAL Core
============================

The GAL Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GAL Core project, and is not to be
confused with overall GAL Network Protocol consensus changes.

Whether a pull request is merged into GAL Core rests with the project merge
...
Patches that change GAL consensus rules are considerably more involved than
...
Where a patch set proposes to change the GAL consensus, it must have been
...
The project leader is the release manager for each GAL Core release.
