...
extern UniValue setzgalseed(const UniValue& params, bool fHelp);
extern UniValue getzgalseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgal(const UniValue& params, bool fHelp);
extern UniValue dzgalstate(const UniValue& params, bool fHelp);
