...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Galerians Core galerians-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  galerians-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded galerians transaction") + "\n" +
                               "  galerians-tx [options] -create [commands]   " + _("Create hex-encoded galerians transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded galerians transaction
