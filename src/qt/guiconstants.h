...
/* Galerians GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GAL"
#define QAPP_ORG_DOMAIN "galerians.org"
#define QAPP_APP_NAME_DEFAULT "GAL-Qt"
#define QAPP_APP_NAME_TESTNET "GAL-Qt-testnet"
