 ...
 */
    ...
    typeWidget->addItem(tr("Received PIV from zGAL"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGAL"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGal));
