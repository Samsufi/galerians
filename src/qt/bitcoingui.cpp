                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GAL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GAL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and galerians: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GAL Core"), this);
    aboutAction->setStatusTip(tr("Show information about GAL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GAL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GAL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GAL addresses"));
    ...
    openAction->setStatusTip(tr("Open a GAL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GAL Core help message to get a list with possible GAL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GAL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GAL network", "", count));
}
...
{
    QString strTitle = tr("GAL Core"); // default title
