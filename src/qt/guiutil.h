...
/** Utility functions used by the GAL Qt UI.
 */
namespace GUIUtil
{
...
// Render GAL addresses in monospace font
...
// Parse "galerians:" URI into recipient object, return true on successful parsing
