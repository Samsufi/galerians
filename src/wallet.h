...
public:
    ...
    string GetUniqueWalletBackupName(bool fzgalAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzGALTracker> zgalTracker;
    ...
    {
        zwalletMain = zwallet;
        zgalTracker = std::unique_ptr<CzGALTracker>(new CzGALTracker(strWalletFile));
    }
    ...
    void setZGalAutoBackups(bool fEnabled)
    {
