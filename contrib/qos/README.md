...
This means one can have an always-on galeriansd instance running, and another local galeriansd/galerians-qt instance which connects to this node and receives blocks from it.
