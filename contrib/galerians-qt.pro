...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/galerians-cli.cpp \
           src/galerians-tx.cpp \
           src/galerians.cpp \
           src/db.cpp \
           ...
           src/qt/galerians.cpp \
           src/qt/galeriansstrings.cpp \
...
RESOURCES += src/qt/galerians.qrc src/qt/galerians_locale.qrc

TRANSLATIONS += src/qt/locale/galerians_bg.ts \
                src/qt/locale/galerians_de.ts \
                src/qt/locale/galerians_en.ts \
                src/qt/locale/galerians_es.ts \
                src/qt/locale/galerians_fi.ts \
                src/qt/locale/galerians_fr.ts \
                src/qt/locale/galerians_it.ts \
                src/qt/locale/galerians_ja.ts \
                src/qt/locale/galerians_pl.ts \
                src/qt/locale/galerians_pt.ts \
                src/qt/locale/galerians_ru.ts \
                src/qt/locale/galerians_sk.ts \
                src/qt/locale/galerians_sv.ts \
                src/qt/locale/galerians_vi.ts \
                src/qt/locale/galerians_zh_CN.ts \
                src/qt/locale/galerians_zh_TW.ts
