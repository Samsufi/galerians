...
Setup
---------
Configuring the github-merge tool for the GAL repository is done in the following way:

    git config githubmerge.repository GAL-Project/GAL
...
A script to optimize png files in the GAL
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_galerians: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_galerians: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_galerians: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_galerians: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
