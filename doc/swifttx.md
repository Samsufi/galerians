...
This mechanism has been integrated into Bitcore-Node-GAL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GAL-Project/insight-api-galerians#web-socket-api](https://github.com/GAL-Project/insight-api-galerians#web-socket-api) 
* API: [https://github.com/GAL-Project/insight-api-galerians#swifttx-transactions](https://github.com/GAL-Project/insight-api-galerians#swifttx-transactions) 
...
By default, the GAL Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GAL Core daemon:
