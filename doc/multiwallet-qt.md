...
In order to support loading of multiple wallets in galerians-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is galerians.cpp.
...
Changes to galerians.cpp
----------------------
galerians.cpp is the entry point into galerians-qt, and as such, will require some minor modifications to provide hooks for
